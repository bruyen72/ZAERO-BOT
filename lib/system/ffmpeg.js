...
export function runFfmpeg(args = [], options = {}) {
  ...
  return new Promise((resolve, reject) => {
    ...
    const timer = setTimeout(() => {
      try {
        // Mata o processo de forma agressiva para liberar CPU/RAM
        child.kill('SIGKILL');
        // No Windows, às vezes o SIGKILL não mata processos filhos do spawn se houver, 
        // mas para ffmpeg direto costuma funcionar.
      } catch {}
    ...
    child.on('close', (code) => {
      ...
      // Se code for null, provavelmente foi morto pelo SIGKILL (timeout)
