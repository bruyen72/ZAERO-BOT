...
const COMMAND_TO_REDGIFS_TAGS = {
  // --- Oral ---
  blowjob: 'blowjob,deepthroat,oral',
  mamada: 'blowjob,deepthroat,oral',
  bj: 'blowjob,deepthroat,oral',
  boquete: 'blowjob,deepthroat,oral',
  chupar: 'blowjob,deepthroat,oral',
  chupada: 'blowjob,deepthroat,oral',
  lickdick: 'blowjob,oral,deepthroat',
  lamberpau: 'blowjob,oral,deepthroat',
  chuparpau: 'blowjob,oral,deepthroat',
  cummouth: 'cum in mouth,cum swallow,blowjob',
  gozarnaboca: 'cum in mouth,cum swallow,blowjob',
  engolir: 'cum in mouth,cum swallow,blowjob',
  leitinho: 'cum in mouth,cum swallow,blowjob',

  // --- Anal ---
  anal: 'anal,anal creampie',
  violar: 'anal,rough',
  cuzinho: 'anal,amateur',

  // --- Fuck ---
  fuck: 'fuck,doggystyle,sex',
  coger: 'fuck,doggystyle,sex',
  foder: 'fuck,doggystyle,sex',
  transar: 'fuck,sex,doggystyle',
  ...
  // --- Masturbacao ---
  fap: 'male masturbation,masturbating,solo',
  paja: 'male masturbation,masturbating,solo',
  punheta: 'male masturbation,masturbating,solo',
  bronha: 'male masturbation,masturbating,solo',
  handjob: 'handjob,cock milking',
  siririca: 'fingering,masturbating,solo',
  grope: 'groping,big tits,boobs',
  apalpar: 'groping,big tits,boobs',

  // --- Seios ---
  grabboobs: 'big tits,boobs,groping',
  agarrarpeitos: 'big tits,boobs,groping',
  peitos: 'big tits,boobs,bouncing tits',
  tetas: 'big tits,boobs,bouncing tits',
  suckboobs: 'sucking tits,big tits,boobs',
  chuparpeitos: 'sucking tits,big tits,boobs',
  chupartetas: 'sucking tits,big tits,boobs',
  boobjob: 'titfuck,titty fuck,big tits',
  espanhola: 'titfuck,titty fuck,big tits',
  ...
  // --- Bunda / Ass ---
  bunda: 'big ass,pawg,ass,twerking',
  ...
  // --- Creampie ---
  creampie: 'creampie,cum,anal creampie',
  ...
  // --- Cum ---
  cum: 'cumshot,cum',
  cumshot: 'cumshot,cum,facial',
  gozar: 'cumshot,cum',
  gozada: 'cumshot,cum,facial',

  // --- Spank ---
  spank: 'spanking,spanked,slapping',
  ...
  // --- Strip ---
  undress: 'striptease,stripping,strip',
  ...
  // --- Feet ---
  footjob: 'footjob,feet,feet fetish',
...
export async function searchRedgifsNiches(niche, limit = CONFIG.MAX_RESULTS_PER_PROVIDER, options = {}) {
  ...
  try {
    ...
    console.warn(`[RedGifs] Niche "${niche}" falhou: ${error.message}`);
    return [];
  }
...
async function tryDownloadCandidate(candidate, fallbackSource, options = {}) {
  ...
  if (validation.size > 0 && validation.size > 18 * 1024 * 1024) {
    console.log(`[MediaFetcher] Skipping: ${(validation.size / 1024 / 1024).toFixed(1)}MB > 18MB`);
    return null;
  }
