// ✅ COMPLETO, INTEIRO, “ATÉ O FINAL” (bem organizado e na ordem que você pediu)
// Ordem: 1) Redes/IG/TikTok  2) Stickers  3) Reações Anime  4) Downloads/Outros  5) Perfil  6) Grupo  7) Bot  8) Dono  9) +18
// Removido APENAS o que você mandou remover: economia/ganhar dinheiro/gerenciar moedas/casino-coinflip/aventuras/gacha/música/trocar-vender.
...
║ 📌 Ex.: *$prefixattp fogo ZAERO* | *$prefixattp olá mundo*
...
╠══ 😊 REAÇÕES POSITIVAS ══
║
║ 🤗 *$prefixabracar* <@user> - Abraçar
║ 💋 *$prefixbeijar* <@user> - Beijar
║ 😘 *$prefixbeijo* <@user> - Beijinho
...
║ 🔍 *$prefiximagem* <termo> - Imagens alternativas
║ 📌 *$prefixpin* <qtd> <termo> - Pinterest fotos (máx 7)
║
╠══ 📦 ARQUIVOS / OUTROS ══
║
...
║ 🔍 *$prefixinspecionar* <url> - Info de grupo WA
...
║ 🔥 *$prefixfoder* <@user> - Foder
║ ✊ *$prefixfap* <@user> - Punheta
║ ✊ *$prefixpunheta* <@user> - Punheta
║ ✊ *$prefixhandjob* <@user> - Masturbação manual
...
║ 👗 *$prefixtirarroupa* <@user> - Tirar roupa
║ 👋 *$prefixspank* <@user> - Dar tapa
║ 👋 *$prefixbaternabunda* <@user> - Bater na bunda
║ 🤲 *$prefixgrope* <@user> - Apalpar
║ 👣 *$prefixfootjob* <@user> - Footjob
║ 💕 *$prefixyuri* <@user> - Yuri/Lésbica
║ 💕 *$prefixtesoura* <@user> - Tesoura lésbica
║
