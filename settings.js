...
const OWNER_NUMBER = String(process.env.BOT_OWNER || process.env.OWNER_NUMBER || '').replace(/\D/g, '')
global.owner = [OWNER_NUMBER || ''] // Configure BOT_OWNER no .env (ex: 5511999999999)
global.botNumber = ''
