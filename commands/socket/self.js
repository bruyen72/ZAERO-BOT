export default {
  ...
  run: async (client, m, args) => {
    ...
    if (args[0] === 'disable' || args[0] === 'off') {
      if (!estado) return m.reply('《✧》 O modo *Self* já estava desativado.')
      chat.self = false
      return m.reply('《✧》 Você tem o modo *Desativado* *Privado*.')
    }
    return m.reply(`*☆ Self (✿❛◡❛)*\n➮ *Estado ›* ${estado ? '✓ Ativado' : '✗ Desativado'}\n\n❀ Você pode alterá-lo com:\n> ● _Ativar ›_ *autoativar*\n> ● _Desativar ›_ *autodesativar*`)
  },
};
