export default {
  ...
  run: async (client, m, args, usedPrefix) => {
    ...
    if (now < user.lastweekly) {
      ...
      return client.reply(m.chat, `ꕥ Você já resgatou sua recompensa semanal.\n> Você pode resgatá-la novamente em *${wait}*`, m)
    }
    ...
    if (lost) msg += `\n> ☆ Você perdeu sua sequência de semanas!`
    client.reply(m.chat, `「❁」 Você reivindicou sua recompensa semanal *¥${coins.toLocaleString()} ${currency}* (Semana *${users.weeklyStreak}*)\n${msg}`, m)
  }
}
