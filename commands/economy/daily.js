export default {
  ...
  run: async (client, m, args, usedPrefix) => {
    ...
    if (now < user.lastdaily) {
      ...
      return m.reply(`ꕥ Você já reivindicou sua *Diária* de hoje.\n> Você pode reivindicá-la novamente em *${restante}*`)
    }
    ...
    if (lost) msg += `\n> ☆ Você perdeu sua sequência de dias!`
    await m.reply(`「✿」Você reivindicou sua recompensa diária *¥${recompensa.toLocaleString()} ${monedas}*! (Día *${users.streak}*)\n${msg}`)
  },
}
